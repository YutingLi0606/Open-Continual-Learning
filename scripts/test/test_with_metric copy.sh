...
# 参数设置
EXPERIMENT_NAME="${1:-ZSCL_evaluation}"
SAVE_PATH="${2:-ckpt/exp_zscl}"
MATRIX_CSV="${3:-accuracy_matrix.csv}"
METRICS_CSV="${4:-zscl_metrics.csv}"
TEST_SH="${5:-scripts/test_zscl.sh}"
...
# 运行矩阵评估
python zscl_matrix_evaluation.py \
    --test-script "$TEST_SH" \
